...
class Wt
{
    ...
    function wt_genre_block ($genre, $str, $sn = false)
    {
        ...
        $wt_game = WebTomat_Data::wt_mysql("SELECT wtg_id,wtg_name,wtg_apppath,wtg_img100,wtg_title,wtg_desc,wtg_tags,wtg_img16,wtg_new,wtg_popular FROM " . WEBTOMAT_PREF . "wtgames WHERE wtg_genres LIKE '%{$genre}%' ORDER BY wtg_popular DESC limit 7");
    ...
    function wt_kroshki ($str)
    {
        ...
        elseif (isset($cat)) {
            ...
            if (WEBTOMAT_DECODE == "windows-1251") {
                $genre_rus = iconv('UTF-8', 'windows-1251', $genre_rus);
            }
        }
        elseif (isset($search)) {
    ...
    function wt_search ()
    {
        $a = file_get_contents(WEBTOMAT_DIR . '/themes/default/wt_searchblock.tpl');
        return $a;
    }
