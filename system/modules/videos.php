...
$result_video_lnk = '<object id="videoplayer3685" type="application/x-shockwave-flash" data="/uppod.swf" width="770" height="420"><param name="bgcolor" value="#ffffff" /><param name="allowFullScreen" value="true" /><param name="allowScriptAccess" value="always" /><param name="movie" value="/uppod.swf" /><param name="flashvars" value="uid=videoplayer3685&amp;comment=LifeOrange&amp;st=video213-626.txt&amp;file=http://www.youtube.com/embed/'.$exp_x[0].'&amp;link=http://uppod.ru/vfvsarsvy" /></object>';
}				
