...
if(isset($_POST['send'])){
	...
	if(isset($title) AND !empty($title)){
		...
		if($sql_){
			...
			msgbox('Информация', '<div class="alert alert-info">Игра успешно добавлена на сайт!</div>', '?mod=apps');
			
			//Удаляем хеш
			unset($_SESSION['apps_hash']);
			
		} else
			msgbox('Ошибка', '<div class="alert alert-info">Заполните все поля</div>', '?mod=apps');
...
if($_GET['act'] == 'del_game'){
	...
	if($row){
		...
		msgbox('Ошибка', '<div class="alert alert-info">Игра удалена</div>', '?mod=apps');;
		
	} else
		msgbox('Ошибка', '<div class="alert alert-info">Игра не найдена</div>', '?mod=apps');;
...
if(isset($_POST['edtisave'])){
	...
	if(isset($title) AND !empty($title)){
		...
		msgbox('Информация', '<div class="alert alert-info">Изменения сохранены</div>', '?mod=apps');
...
echo <<<HTML
<script type="text/javascript" src="/system/inc/js/apps/jquery.js"></script>
<script type="text/javascript" src="/system/inc/js/apps/upload.photo.js"></script>
...
<ol class="breadcrumb">
 ...
 <div class="table-responsive">
	<div class="col-lg-12">
		<div class="box-header"><small>Редактирование игры</small></div>
	    <table class="table table-bordered table-hover table-striped">
			<tbody>
				...
				<tr>
					<td><h6>Ширина flash игры (px):</h6></td>
					<td> <input type="text" name="width" class="inpu" value="{$row['width']}" /></td>
				</tr>
				<tr>
					<td><h6>Высота flash игры (px):</h6></td>
					<td><input type="text" name="height" class="inpu" value="{$row['height']}" /></td>
				</tr>
				<tr>
					<td><h6>Скриншоты 607х376:</h6></td>
					<td>
...
<div class="col-lg-12">
 <input type="submit" value="Сохранить" class="btn btn-primary" name="edtisave" style="margin-top:0px" />
...
<form action="" method="POST">
 <div class="table-responsive">
	<div class="col-lg-12">
		<div class="box-header"><small>Добавление игры</small></div>
	    <table class="table table-bordered table-hover table-striped">
			<tbody>
				<tr>
					<td style="height:30px;"><h6>Название:</h6></td>
					<td class="col-lg-4"><input type="text" name="title" class="form-control form-cascade-control" /></td>
				</tr>
				<tr>
					<td><h6>Описание:</h6></td>
					<td><textarea type="text" name="descr" class="form-control form-cascade-control" rows="3"></textarea></td>
				</tr>
				<tr>
					<td><h6>Постер 75х75:</h6></td>
					<td>
				...
				<tr>
					<td><h6>Ширина flash игры (px):</h6></td>
					<td> <input type="text" name="width" class="inpu" value="795" /></td>
				</tr>
				<tr>
					<td><h6>Высота flash игры (px):</h6></td>
					<td><input type="text" name="height" class="inpu" value="495" /></td>
				</tr>
				<tr>
					<td><h6>Скриншоты 607х376:</h6></td>
					<td>
...
<div class="col-lg-12">
 <input type="submit" value="Добавить игру" class="btn btn-primary" name="send" style="margin-bottom:20px" />
...
<div class="table-responsive">
	<div class="col-lg-12">
		<div class="box-header"><small>Поиск</small></div>
	    <table class="table table-bordered table-hover table-striped">
			<tbody>
				<tr>
					<td style="height:30px;"><h6>По названию:</h6></td>
					<td class="col-lg-4"><input type="text" name="title" class="inpu" value="{$title}" /></td>
				</tr>
				<tr>
					<td><h6>По ID:</h6></td>
					<td><input type="text" name="id" class="inpu" value="{$id}" /></td>
				</tr>
			</tbody>
         </table>
		 </div>
