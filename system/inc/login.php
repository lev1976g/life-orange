...
if(isset($_SESSION['user_id']) > 0){
	...
	$user_info = $db->super_query("SELECT user_id, user_email, user_name, user_lastname, user_photo, user_group, user_password FROM `".PREFIX."_users` WHERE user_id = '".$logged_user_id."'");
...
<div class="form-group">
    <label>E-mail:</label>
      <input type="text" name="email" class="form-control" /><font color="red">{$error_log}</font>
</div>
<div class="form-group">
    <label>Пароль:</label>
