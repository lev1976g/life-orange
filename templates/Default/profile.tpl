...
<div class="profiewr">
 ...
 [phet]
<a href="/albums/{user-id}" style="text-decoration:none" onclick="Page.Go(this.href); return false"><div class="albtitle" style="margin-top:5px">Фотографии<div class="mono_ico_albums" onMouseOver="myhtml.title('7', 'Показать все альбомы', 'newBBlockl')" id="newBBlockl7"></div></div></a>
<div class="" style="margin-top:5px;">{five-photo}</div>
[/phet]
...
<tbody>
<tr>
    <td><div class="wall_attach_icon_smile" id="wall_attach_link" onClick="wall.attach_addsmile()">Смайлик</div></td>
    <td><div class="wall_attach_icon_photo" id="wall_attach_link" onClick="wall.attach_addphoto()">Фотографию</div></td>
    <td><div class="wall_attach_icon_video" id="wall_attach_link" onClick="wall.attach_addvideo()">Видеозапись</div></td>
    <td><div class="wall_attach_icon_audio" id="wall_attach_link" onClick="wall.attach_addaudio()">Аудиозапись</div></td>
    <td><div class="wall_attach_icon_doc" id="wall_attach_link" onClick="wall.attach_addDoc()">Документ</div></td>
    <td><div class="wall_attach_icon_vote" id="wall_attach_link" onClick="$('#attach_block_vote').slideDown('fast');wall.attach_menu('close', 'wall_attach', 'wall_attach_menu');$('#vote_title').focus();$('#vaLattach_files').val($('#vaLattach_files').val()+'vote|start||')">Опрос</div></td>
</tr>
</tbody>
</table>
