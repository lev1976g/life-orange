...
$(document).ready(function(){
	...
	myhtml.checked(['{settings-comments}', '{settings-pages}', '{settings-discussion}']);
	music.jPlayerInc();
...
[noovn]<div class="button_blue fl_l" style="margin-bottom:15px;line-height:15px"><button onClick="groups.login('{id}'); return false" style="width:174px">Подписаться</button></div>[/noovn]
    [yovn1]<div class="button_blue fl_l" style="margin-bottom:15px;line-height:15px"><button onClick="groups.login('{id}'); return false" style="width:174px">Подписаться</button></div>[/yovn1]
    [yovn2]<div class="button_blue fl_l" style="margin-bottom:15px;line-height:15px"><button onClick="groups.login('{id}'); return false" style="width:174px">Подписаться</button></div>[/yovn2]
    [yovn3]<div class="button_blue fl_l" style="margin-bottom:15px;line-height:15px"><button onClick="groups.login('{id}'); return false" style="width:174px">Подписаться</button></div>[/yovn3]
...
<div class="profiewr">
 ...
 [admin]<div class="public_editbg fl_l no_display" id="edittab1">
  ...
  <div class="mgclr"></div>
<div class="texta">Огр. на возраст:</div>
  <select id="onv" class="inpst" style="width: 81px;margin-left:0px">
  <option>Без огр.</option>
  {onv}
 </select>
 <div class="mgclr"></div>
  ...
  <div class="mgclr clear"></div>
    <div class="texta">&nbsp;</div>
 <div class="html_checkbox" id="pages" onClick="myhtml.checkbox(this.id)" style="margin-bottom:8px">Свежие новости</div>
  <div class="mgclr clear"></div>
  <div class="texta">&nbsp;</div>
 ...
 <div class="public_editbg fl_l no_display" id="edittab2">
  ...
  [pages]
 <div class="clear" style="border-bottom:1px solid #F3F3F3;margin: 20px -12px 0px -12px;"></div>

<div class="cursor_pointer" onClick="Profile.MoreInfo(); return false" id="moreInfoLnk"><div class="public_wall_all_comm profile_hide_opne">{npages}<a href="/pages{id}" onclick="Page.Go(this.href); return false" style="margin-left: 7px;"id="moreInfoLnk">[admin]<div style="margin: 2px;float:right">ред.</div>[/admin]</a></div></div>
 <div id="moreInfo" >
...
<div class="clear"></div><div style="margin-bottom:10px;"></div>
