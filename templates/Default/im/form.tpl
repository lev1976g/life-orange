...
<div></div>
<br>
<div id="im_smile" title="Используйте TAB, чтобы быстрее открывать смайлы" class="fl_l" onclick="wall.attach_addsmile()" style="opacity: 0.7; "><div style="margin-left:60px" class="im_smile_icon_on"></div><div style="margin-left:-10px;margin-top:-10px" class="im_smile_icon"></div></div>
