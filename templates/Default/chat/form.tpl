...
<textarea name="message" class="videos_input wysiwyg_inpt fl_l im_msg_texta" id="textcom" style="width:640px;height:20px" placeholder="Введите Ваше сообщение.." onkeypress="if(event.keyCode == 10 || (event.keyCode == 13)) chatz.send()"></textarea>
