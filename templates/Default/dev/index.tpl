...
<script src="{theme}/dev/js/dev.js" type="text/javascript">
var Dev = {
init: function(opts) {
...
<a class="button_div fl_l" href="/editapp/create">
...
<b>Test</b>
– самый быстрорастущий сайт европейского интернета. Его аудитория удваивается каждые несколько месяцев, и сейчас на Test приходится более половины русскоязычного трафика. Если Вы хотите заниматься разработкой приложений в интернете, Вы можете приобщиться к этому успеху и получить доступ к аудитории свыше
<b>3 тысяч</b>
пользователей.
</div>
<br class="clear">
...
<a class="dev_part" href="/dev/met">
<div class="dev_part_name">Документация платформы</div>
<div class="dev_part_desc">Описание возможностей платформы Test: процедура авторизации приложения, серверные и клиентские методы API, создание приложений и подключение сайтов.</div>
</a>
...
<div class="dev_part_desc">Правила публикации приложений на площадке Test, размещение рекламы в приложениях, прием платежей от пользователей.</div>
</a>
