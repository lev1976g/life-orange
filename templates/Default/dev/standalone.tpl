...
<br>
<br>
Это открывает широкие возможности для создания как полнофункциональных клиентов LifeOrange (например, официальное приложение для Android), так и различных сервисов, в которых информация, полученная с помощью API LifeOrange, играет вспомогательную роль.
<br>
<br>
...
<b>
<a class="wk_vk_link" href="/editapp/create">здесь</a>
</b>
, необходимый тип —
...
<a class="wk_vk_link" href="/">LifeOrange</a>
.
<br>
<br>
